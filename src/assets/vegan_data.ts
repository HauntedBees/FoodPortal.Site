...
export const FoodCategories:FoodCategory[] = [
    {
        ...
        emoji: "1F9C0", unit: "oz", name: "Cheese", id: "cheese"
    }, {
        ...
        emoji: "1F95A", unit: "oz", name: "Egg", id: "egg"
    }, {
        ...
        emoji: "1F95B", unit: "qt", name: "Milk", id: "milk"
    }, {
        ...
        emoji: "1F357", unit: "oz", name: "Poultry", id: "poultry"
    }, {
        ...
        emoji: "1F356", unit: "oz", name: "Misc. Meat", id: "meat"
    }, {
        ...
        emoji: "1F372", unit: "package", name: "Combination", id: "combo"
    }
];
const Food:{[key:string]:Product[]} = {
    "meat": [
        {
            brand: "Alpha", item: "The Alpha Crumble - Meatless Sausage", date: "2020-06-08", url: "https://alphaplantbased.com/our-products/alpha-crumble/", 
            desc: "I've haven't eaten much actual sausage, so I'm no expert on it, but what I do know is that this stuff is great. Great texture, great flavor.", 
            pros: "Good texture, better flavor.", 
            cons: "None.",
            unitPrice: "0.69", rating: 9.5, restrictions: ["soy", "gluten"]
        }, {
    ...
    "poultry": [
        {
            ...
            cons: "Inner flavor is somewhat bland.",
            unitPrice: "0.58", rating: 8.5, restrictions: ["soy", "gluten", "corn"]
        }, {
            brand: "Laura's Lean", item: "Plant-based Nuggets", date: "2020-06-20", url: "https://www.laurasleanbeef.com/products/plant-based-meat/plant-based-nuggets", 
            desc: "A solid nuggie. The breading is good, the texture is chicken-esque. The flavor is clearly vegetal, but not in the standard \"this just tastes like broccoli and carrots\" way that you'd get when a boring white mom tries to feed her kids \"healthy, but FUN!\" food. The veggie flavor is mild and doesn't detract, but you won't fool anyone into thinking these are real chicken nuggets.", 
            pros: "Great texture, crispy outside, good flavor.", 
            cons: "Hint of veggie in every bite.",
            unitPrice: "0.78", rating: 7, restrictions: ["soy", "gluten"]
        }, {
            ...
            unitPrice: "0.5", rating: 8.5, restrictions: ["soy", "gluten"]
        }, {
            ...
            unitPrice: "0.47", rating: 9.5, restrictions: ["gluten", "egg", "milk"]
        }, {
    ...
    "beef": [
        {
            brand: "Alpha", item: "The Alpha Crumble - Original Beefy", date: "2020-06-13", url: "https://alphaplantbased.com/our-products/alpha-crumble/", 
            desc: "It was good in the empanadas I made. Possibly a bit drier than regular ground beef, but when seasoned right it works great.", 
            pros: "Good texture, good flavor.", 
            cons: "Ever so slightly dry.",
            unitPrice: "0.69", rating: 9, restrictions: ["soy", "gluten"]
        }, {
            ...
            desc: "The texture and flavor are both pretty A+. No complaints aside from the uncooked smell.", 
            ...
            unitPrice: "0.25", rating: 9.5, restrictions: ["soy", "gluten"]
        }, {
            ...
            unitPrice: "0.75", rating: 0, restrictions: ["peas"]
        }, {
    ...
    "milk": [
        {
            brand: "Chobani", item: "Extra Creamy Oat Drink", date: "2020-06-17", url: "https://www.chobani.com/products/oat-based/drink/Plain-Extra-Creamy/",
            desc: "Tasty and great with cereal and in lattes, but too sweet and too oaty to drink on its own.",
            pros: "Perfectly smooth and creamy texture.",
            cons: "Very sweet, with a strong oat flavor.",
            unitPrice: "2.74", rating: 8, restrictions: []
        }, {
...
for(const key in Food) {
    const cat = FoodCategories.filter(c => c.id === key)[0];
    Food[key].forEach(f => { f.type = cat; });
}
export default Food;